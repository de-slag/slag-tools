...
echo "server setup version 3"
echo "This scipt is supposed to set up a linux server."
echo "It should can be executed mutiple times, also future versions."
echo "It only create things, it does not cleans up things from further versions."
echo
